...
interface ITableHeaderProps {
  ...
  toggleImportUserAgentModal: MouseEventHandler<HTMLButtonElement> | undefined,
  handlesearchbox:any
}
  ...
  return (
    ...
    >
      ...
      <Box>
        ...
        >
        Add Patients & Team Member{/*   Add Users & Agents */}
        </Button>
        <Button
          sx={{ mb: 2, p: 3, ml: 2,textTransform: 'capitalize' }}
          variant='outlined'
          startIcon={<IconTableExport color='#2D4ACD' />}
          onClick={props.toggleImportUserAgentModal}
        >
          Import Patients & Team Member
        </Button>
      </Box>
    </Box>
  )
