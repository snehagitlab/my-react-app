...
const REACT_APP_SITE_KEY = process.env.REACT_APP_SITE_CAPTCHA_URL
...
const Signup = () => {
  ...
  const onChangeCaptcha = async (value: any) => {
  ...
  const handleFreeTrail = async () => {
    ...
    Object.assign(requestData, { captchaValue: captchaValue })
  ...
  return (
    <>
      <Helmet>
        <title>Welcome - Gogtas</title>
        <meta name="description" content="Welcome - Gogtas" />
    </Helmet>
      ...
      <Grid>
        <Box
          ...
          sx={{
            backgroundImage: `linear-gradient(${theme.palette.primary.main} 70%,${theme.palette.primary.main} 30%)`,
            color: 'darkred',
            position: 'relative'
          }}
        >
                    ...
                    <Grid container spacing={3}>
                      ...
                      <Grid item>
                        <FormControl fullWidth>
                          ...
                          <ReCAPTCHA
                            sitekey={REACT_APP_SITE_KEY ? REACT_APP_SITE_KEY : ''}
